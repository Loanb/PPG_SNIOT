...
enum max30102_attribute
{
    MAX30102_ATTR_LED_PA = SENSOR_ATTR_PRIV_START,
    /**
     * Set acquisition state.
     * val1 = 1 to start acquisition (sets configured mode).
     * val1 = 0 to stop acquisition (sets shutdown mode).
     */
    MAX30102_ATTR_ACQUISITION,
};
...
struct max30102_data
{
    ...
    K_KERNEL_STACK_MEMBER(thread_stack, CONFIG_MAX30102_THREAD_STACK_SIZE);
